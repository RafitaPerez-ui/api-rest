...
@ApiOperation(value="Metodo para saber el estatus de una cuenta", nickname="Transferencias",
		...
		@GetMapping(value="/tranfiere/historial", produces = MediaType.APPLICATION_JSON_VALUE)
		public ResponseEntity<?> Historial(
				@Valid @RequestHeader(defaultValue="eyJhbGciOiJSUzM4NCIsInR5cCI6IkpXVCJ9..bGDQoQTibydo10-EIOnI9cfSJUI2SsA3UUYbnn-0K9qRzL-kstxbe4cqBirh3-Gayjw0rrqkDKkeZi-4MCrGDx4tf2eaABQPsrbD0IixydOKT2DuIHOk383OkigCq9ppr1o9OUrwpsVn_W9QROIQRpQcWqgHsMdzY73j2Qv9oNI", name="Token", required=true) String token,
				@NotBlank @ApiParam(type="String", value="20181029122219122220158056") @RequestParam(name="cuenta", required = true) String cuenta)
		{
			LOG.info("Controller - Historial");
			return this.moneyTransferBI.ObtenHistorial(cuenta);
	    }
	
			@ApiOperation(value="Metodo para saber el historial de una cuenta", nickname="Transferencias",
				  response=ResponseTO.class, tags={"Api-Rest"})
		@ApiResponses({@ApiResponse(code=200, message="Ok", response=ResponseTO.class),
			@ApiResponse(code=400, message="Entrada incorrecta", response=ResponseError.class),
			@ApiResponse(code=404, message="No encontrado", response=ResponseError.class),
			@ApiResponse(code=500, message="Error inesperado", response=ResponseError.class)})
		@GetMapping(value="/tranfiere/cuenta", produces = MediaType.APPLICATION_JSON_VALUE)
		public ResponseEntity<?> Cuenta(
				@Valid @RequestHeader(defaultValue="eyJhbGciOiJSUzM4NCIsInR5cCI6IkpXVCJ9..bGDQoQTibydo10-EIOnI9cfSJUI2SsA3UUYbnn-0K9qRzL-kstxbe4cqBirh3-Gayjw0rrqkDKkeZi-4MCrGDx4tf2eaABQPsrbD0IixydOKT2DuIHOk383OkigCq9ppr1o9OUrwpsVn_W9QROIQRpQcWqgHsMdzY73j2Qv9oNI", name="Token", required=true) String token,
				@NotBlank @ApiParam(type="String", value="20181029122219122220158056") @RequestParam(name="cuenta", required = true) String cuenta)
		{
			LOG.info("Controller - Cuenta");
			return this.moneyTransferBI.obtenerCuenta(cuenta);
	    }
